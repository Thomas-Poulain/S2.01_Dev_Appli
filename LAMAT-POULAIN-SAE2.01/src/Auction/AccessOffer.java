...
public class AccessOffer {
    ...
    public void addAOffer(Auction auction, int nominalPrice, int nbNight,  Tenant tenant, int nbPers){
        offers.add(new Offer(auction , nominalPrice, nbNight, tenant,nbPers));
    }
